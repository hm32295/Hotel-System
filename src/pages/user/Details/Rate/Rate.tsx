...
export default function Rate({id}) {
  ...
  return (
    <Box  sx={{  display: 'flex', alignItems: 'flex-start',gap:'1.5rem',flexDirection:'column',justifyContent:'center' }}>
        ...
        {errors.review&&<Typography sx={{color:'red',textTransform:'capitalize'}}>{errors?.review?.message}</Typography>}
